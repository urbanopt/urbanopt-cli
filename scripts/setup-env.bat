...
SET UO_DIR=%BASE_DIR_NAME%

SET GEM_HOME=%BASE_DIR_NAME%\gems\ruby\%RUBY_BASE_VERSION%
SET GEM_PATH=%BASE_DIR_NAME%\gems\ruby\%RUBY_BASE_VERSION%
SET UO_GEMFILE_PATH=%UO_DIR%\openstudio-runtime-gems\Gemfile
SET UO_BUNDLE_INSTALL_PATH=%UO_DIR%\openstudio-runtime-gems
SET PATH=%BASE_DIR_NAME%;%BASE_DIR_NAME%\ruby\bin;%BASE_DIR_NAME%\gems\ruby\%RUBY_BASE_VERSION%\bin;%PATH%
...
echo SET "UO_GEMFILE_PATH=%UO_GEMFILE_PATH%">> "%HOMEPATH%\.env_uo.bat"
echo SET "UO_BUNDLE_INSTALL_PATH=%UO_BUNDLE_INSTALL_PATH%">> "%HOMEPATH%\.env_uo.bat"
